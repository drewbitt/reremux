# From https://github.com/drewbitt/splitBDchapters

# Currently just being used for adding generic chapter names, but would like a full implementation soon where it will
# compare video lengths to existing chapters and then split into individual episode chapter files
